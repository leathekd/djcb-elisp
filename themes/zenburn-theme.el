...
(let ( (zenburn-fg		"#dcdccc")
  ...
  (custom-theme-set-faces
    ...
    `(rainbow-delimiters-depth-6-face ((t (:foreground ,zenburn-blue-5))))
    `(rainbow-delimiters-depth-7-face ((t (:foreground ,zenburn-green-1))))
    `(rainbow-delimiters-depth-8-face ((t (:foreground ,zenburn-red-3))))
    `(rainbow-delimiters-depth-9-face ((t (:foreground ,zenburn-yellow-2))))
    `(rainbow-delimiters-depth-10-face ((t (:foreground ,zenburn-green+4))))
